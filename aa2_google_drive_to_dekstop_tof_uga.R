####################################################################################
####### Object: Google Drive to Local Drive  and  adapted to TOF Uganda 
####### Author:  remi.dannunzio@fao.org                               
####### Update:  2017/10/22   and 2019/01/03                                 
###################################################################################
...
dir.create(paste0(dd_dir,"time_series_image_dir/landsat/"),recursive = T)
dir.create(paste0(dd_dir,"time_series_image_dir/sentinel/"),recursive = T)
